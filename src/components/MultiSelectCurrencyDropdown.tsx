      ...
      <div className="flex gap-3">
        <Popover open={open} onOpenChange={setOpen}>
          <PopoverTrigger asChild>
            <Button
              variant="outline"
              className="flex-1 justify-start border-blue-200 hover:border-blue-300"
            >
      ...
      {selectedCurrencies.length > 0 && (
        <div className="flex flex-wrap gap-2">
          {selectedCurrencies.map(code => {
            ...
            return currency ? (
              <div key={code} className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm flex items-center gap-1">
