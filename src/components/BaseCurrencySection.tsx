        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Switch
              ...
              className="data-[state=unchecked]:bg-blue-200 data-[state=checked]:bg-blue-600 h-1.5 w-3 [&>span]:h-1.25 [&>span]:w-1.25 [&>span]:data-[state=checked]:translate-x-1.5 [&>span]:bg-white [&>span]:border-blue-300 [&>span]:border"
            />
          </TooltipTrigger>
          <TooltipContent>
